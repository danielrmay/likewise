...
window.addEventListener('load', () => {
  ...
  headers.forEach(header => {
    ...
    // Only top-level (H2) sections — H1 is the chapter title and
    // H3+ produces too much clutter on long chapters.
    if (parent.tagName !== "H2") return;
    if (parent.classList.contains("toc-ignore")) return;
