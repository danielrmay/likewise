...
expected to ship with v0.1.1; until it does, implementers
SHOULD test against the reference implementation's produced
signatures byte-for-byte before claiming Level 1 conformance
